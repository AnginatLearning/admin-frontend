...
import { setQuery } from '../../../store/reducers/SearchReducer';
...
const Header = ({ onNote }) => {
  ...
  const SubmitSearch = (e) => {
    e.preventDefault();
    dispatch(setQuery(queryState)); // Update the Redux state
    navigate("/all-courses"); // Navigate to the "All Courses" page
  };

  const handleSearchChange = (e) => {
    setQueryState(e.target.value);  // Update local state
    dispatch(setQuery(e.target.value));  // Dispatch the action to the Redux store
  };
                    ...
                    <img
                      src={(() => {
                        try {
                          ...
                          return institutionDetails.profileUrl || profile;
                        } catch {
                          return profile;
                        }
                      })()}
